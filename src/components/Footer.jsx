...
const Footer = ({ theme }) => {
  ...
  pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40"
    >
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            ...
            />
            <button className="text-white bg-primary rounded px-6">
              Subscribe
            </button>
          </div>
        </motion.div>
      ...
      >
        <p> Copyright 2025 © Koushik - All Right Reserved.</p>
